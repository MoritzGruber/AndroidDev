...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    switch(which){
                        ...
                        case 2: //choose a photo
                            ...
                            Log.d(TAG, "choosePhotoIntent= " + choosePhotoIntent + " data: " + choosePhotoIntent.getData());
    ...
    private Uri getOutputMediaFileUri(int mediaType) {
        if (isExtrnalSotrageAvailable()) {
            //1. get directory
            String appName = MainActivity.this.getString(R.string.app_name);
            File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), appName);
            //2. create our subdircotry
            if (!mediaStorageDir.exists()) {
                if (!mediaStorageDir.mkdirs()) {
                    Log.e(TAG, getString(R.string.error_create_dir));
                    return null;
                }
            }
            //3. create file name
    ...
    private boolean isExtrnalSotrageAvailable(){
